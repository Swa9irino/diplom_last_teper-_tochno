            ...
            <div class="hover__items" @mouseleave="hideElement">
                ...
                <div class="links" v-if="isVisible===true">
                    <div v-for="link in links.slice(0,3)" :key="link.id" @click="handlers[link.id]">
                        <a href="#gadget"><img :src="'assets/' + link.img" alt="" class=""></a>
                        <a href="#gadget"><h3>{{ link.name }}</h3></a>
                    </div>
                </div>
    ...
    <section>
        ...
        <div class="slider container" v-if="currentPage==='home'">
            ...
            <div class="title__container">
                ...
                <p v-if="currentImageIndex===1" class="title__container-second"><span style="position: relative"><img src="assets/applelogo.png" style="width: 18px;position: absolute;left: -13px;top: -1px;"> iPhone 14 Теперь Розовый <br> Встроенная память 8/126 <br> ГБЗаряд батареи 3095 мА·ч <br>Основная камера (Мп)12 + 12</span>
                </p>
            ...
            <div class="pagination">
                        <span v-for="(slide, index) in images" :key="index" @click="goToSlide(index)" :class="{ active: currentImageIndex === index }"><p>{{ index + 1 }}</p></span>
            </div>
        </div>
                    ...
                    <div class="sort__img" >
                        ...
                        if (mysqli_num_rows($result2) > 0) {
                            ...
                            while ($row2 = mysqli_fetch_assoc($result2)) {
                                echo ' <div class="sort__item"><a href="product.php?id=' . $row2['id'] . '">'  . "<img  src=\"{$row2['img']}\">". "<p>{$row2['name']}.<br>Price:".$row2["price"] . '</p></a></div><br>';
//
                            }
                        } else {
                            echo 'No products found';
                    ...
                    <div class="sort__img" >
                        ...
                        if (mysqli_num_rows($result3) > 0) {
                            ...
                            while ($row3 = mysqli_fetch_assoc($result3)) {
                                echo '<div class="sort__item"><a href="product.php?id=' . $row3['id'] . '"><img src="' . $row3['img'] . '">' . '<p>' . nl2br($row3['name']) . '<br>Price: ' . $row3['price'] . '</p></a></div><br>';
//
                            }
                        } else {
                            echo 'No products found';
                    ...
                    <div class="sort__img" >
                        ...
                        if (mysqli_num_rows($result5) > 0) {
                            ...
                            while ($row5 = mysqli_fetch_assoc($result5)) {
                                echo ' <div class="sort__item"><a href="product.php?id=' . $row5['id'] . '">'  . "<img  src=\"{$row5['img']}\">". "<p>". nl2br($row5['name']) .'<br>Price: ' . $row5['price'] . '</a></div><br>';
//
                            }
                        } else {
                            echo 'No products found';
                    ...
                    <div class="sort__img" >
                        ...
                        if (mysqli_num_rows($result4) > 0) {
                            ...
                            while ($row4 = mysqli_fetch_assoc($result4)) {
                                echo ' <div class="sort__item"><a href="product.php?id=' . $row4['id'] . '">'  . "<img  src=\"{$row4['img']}\">". "<p>". nl2br($row4['name']) .'<br>Price: ' . $row4['price'] .'</p></a></div><br>';
//
                            }
                        } else {
                            echo 'No products found';
                    ...
                    <div class="sort__img" >
                        ...
                        if (mysqli_num_rows($result6) > 0) {
                            ...
                            while ($row6 = mysqli_fetch_assoc($result6)) {
                                echo '<div class="sort__item"><a href="product.php?id=' . $row6['id'] . '"><img src="' . $row6['img'] . '"><p>' . nl2br($row6['name']) . '<br>Price: ' . $row6['price'] . '</p></a></div><br>';
//
                            }
                        } else {
                            echo 'No products found';
...
<!--    </section>-->
    <!---------------------------------------------------------------------------------------------------------------------------------------------->
    <section v-if="currentPage==='question'">
        <div class="question" >
            ...
            <div class="faq-container">
                ...
                <div class="faq-item">
                    ...
                    <label for="faq-1" class="faq-question">Как работает наш сайт сравнения цен?</label>
                    <div class="faq-answer">
                        <p>Наш сайт агрегирует информацию о ценах на товары и услуги от различных интернет-магазинов и сервисов. Вы можете воспользоваться поиском по наименованию товара или услуги и выбрать лучшее предложение, используя нашу систему фильтрации и сортировки результатов.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <input type="checkbox" id="faq-2" class="faq-input">
                    <label for="faq-2" class="faq-question">Какая информация о товаре доступна на сайте?</label>
                    <div class="faq-answer">
                        <p>На странице с результатами поиска вы можете увидеть информацию о цене на товар или услугу, название товара, описание продукта, изображения и ссылки на сайты, где вы можете совершить покупку.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <input type="checkbox" id="faq-3" class="faq-input">
                    <label for="faq-3" class="faq-question">Как мы зарабатываем на своей деятельности?</label>
                    <div class="faq-answer">
                        <p>Только поддержка пользователей.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <input type="checkbox" id="faq-4" class="faq-input">
                    <label for="faq-4" class="faq-question">Как часто обновляются данные на сайте?</label>
                    <div class="faq-answer">
                        <p>Данные на сайте обновляются несколько раз в день, чтобы быть максимально актуальными. Однако, мы не гарантируем 100% точность цен и наличия товаров.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <input type="checkbox" id="faq-5" class="faq-input">
                    <label for="faq-5" class="faq-question">Как связаться с нами, если возникнут проблемы?</label>
                    <div class="faq-answer">
                        <p>Вы можете связаться с нашей службой поддержки в группе VK.</p>
                    </div>
                </div>
            </div>
...
<section v-if="currentPage==='home'">
    <header>
        <h1>Новости на сайте "CHEAPFINDER"</h1>
    </header>
    <div class="news__container">
        <div class="news__item">
            <img src="https://s0.rbk.ru/v6_top_pics/resized/590xH/media/img/6/04/346859886890046.jpeg" alt="Изображение новости 1">

            <div class="overlay">
                <h2>Apple представила новый MacBook Air и 2 настольных компьютера</h2>
                <p>Компания представила легкий ноутбук MacBook Air, компактный компьютер Mac Studio и настольный компьютер Mac Pro</p>
                <a target="_blank" href="https://www.rbc.ru/technology_and_media/05/06/2023/647e1ad79a794764c68a13cc">Читать далее</a>
            </div>

        </div>
        <div class="news__item"> <img src="https://s0.rbk.ru/v6_top_pics/resized/590xH/media/img/5/44/756648141649445.webp" alt="Изображение новости 2">
            <div class="overlay">
                <h2>Nvidia объявила о закрытии всех своих офисов в России</h2>
                <p>Представитель Nvidia сообщил, что 30 сентября сотрудникам объявили о закрытии российского офиса из-за «невозможности обеспечить эффективную работу».</p>
                <a target="_blank" href="https://www.rbc.ru/business/03/10/2022/633b0ab99a79475f87188377">Читать далее</a> </div>
        </div>
        <div class="news__item"> <img src="https://s0.rbk.ru/v6_top_pics/resized/590xH/media/img/0/64/756480510454640.jpg" alt="Изображение новости 3">
            <div class="overlay">
                <h2> Cпрогнозировано уменьшение поставок техники Xiaomi в Россию</h2>
                <p>Возможное сокращение поставок Xiaomi связано с падением рубля и сбоями в логистике.</p> <a target="_blank"  href="https://www.rbc.ru/business/23/03/2022/623b400b9a79476832cb715d">Читать далее</a> </div>
        </div>
        ...
        <footer class="footer container" style="margin: 0 auto">
            ...
            <div class="about__container">
                <div class="about">
                    ...
                    <a href="#" @click.prevent="currentPage='question'"><h3>Вопросы</h3></a>
                </div>
